...
function defaultVeljavnaDo(): string {
  const d = new Date();
...
export default function NovaPonudbaPage() {
  ...
  const [veljavnaDo, setVeljavnaDo] = useState(defaultVeljavnaDo());
  ...
  return (
    <div className="px-5 py-6 pb-32 flex flex-col gap-6">
      ...
      <h1 className="font-serif text-3xl tracking-tighter text-text">Nova ponudba</h1>
